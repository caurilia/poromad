                        ...
                        <div class="team_item animated bounce" style="animation-delay: .3s">
                            <div class="team_image">
                                ...
                                <div class="team_caption">
                                    <p><?php echo esc_attr(onepage_get_option('onepage_member1_image_link', __('Duis sed odio sit amet nibh vulputate cursus a kind of changes without touching any code','one-page'))); ?></p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team_item animated bounce" style="animation-delay: .6s">
                            <div class="team_image">
                                ...
                                <div class="team_caption">
                                    <p><?php echo esc_attr(onepage_get_option('onepage_member2_image_link', __('Duis sed odio sit amet nibh vulputate cursus a kind of changes without touching any code','one-page'))); ?></p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team_item animated bounce" style="animation-delay: .9s">
                            <div class="team_image">
                                ...
                                <div class="team_caption">
                                    <p><?php echo esc_attr(onepage_get_option('onepage_member3_image_link', __('Duis sed odio sit amet nibh vulputate cursus a kind of changes without touching any code','one-page'))); ?></p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team_item animated bounce" style="animation-delay: 1.2s">
                            <div class="team_image">
                                ...
                                <div class="team_caption">
                                    <p><?php echo esc_attr(onepage_get_option('onepage_member4_image_link', __('Duis sed odio sit amet nibh vulputate cursus a kind of changes without touching any code','one-page'))); ?></p>
                                </div>
                            </div>
